 ...
 * Description:       Professional SEO & GEO plugin with full Polylang multilingual support. Google News/Video/Image sitemaps with XSL stylesheet, hreflang, IndexNow, AI crawler management, FAQPage/HowTo/Speakable schema, advanced robots directives, and more.
 * Version:           2.0.0
 * Author:            Your Name
...
function plseo_init(): void {
    ...
    // Deferred ping (batches rapid publishes into a single ping)
    add_action( 'plseo_deferred_ping', [ PLSEO_Sitemap::get_instance(), 'ping_search_engines' ] );
...
function plseo_deactivate(): void {
    ...
    wp_clear_scheduled_hook( 'plseo_deferred_ping' );
    flush_rewrite_rules();
}
